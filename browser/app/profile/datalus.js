...
// Non-static prefs that are specific to desktop Datalus belong in this file
...
pref("extensions.getAddons.search.browseURL", "https://addons.mozilla.org/%LOCALE%/datalus/search?q=%TERMS%&platform=%OS%&appver=%VERSION%");
pref("extensions.getAddons.link.url", "https://addons.mozilla.org/%LOCALE%/datalus/");
pref("extensions.getAddons.langpacks.url", "https://services.addons.mozilla.org/api/v4/addons/language-tools/?app=datalus&type=language&appversion=%VERSION%");
pref("extensions.getAddons.discovery.api_url", "https://services.addons.mozilla.org/api/v4/discovery/?lang=%LOCALE%&edition=%DISTRIBUTION%");

// The URL for the privacy policy related to recommended extensions.
pref("extensions.recommendations.privacyPolicyUrl", "https://www.mozilla.org/privacy/datalus/?utm_source=datalus-browser&utm_medium=datalus-browser&utm_content=privacy-policy-link#addons");
// The URL for Datalus Color, recommended on the theme page in about:addons.
pref("extensions.recommendations.themeRecommendationUrl", "https://color.datalus.com/?utm_source=datalus-browser&utm_medium=datalus-browser&utm_content=theme-footer-link");
...
pref("browser.dictionaries.download.url", "https://addons.mozilla.org/%LOCALE%/datalus/language-tools/");
...
// datalus-branding.js (app.update.checkInstallTime.days)
...
#ifdef XP_MACOSX
  // If set to true, Datalus will automatically restart if it is left running
...
pref("lightweightThemes.getMoreURL", "https://addons.mozilla.org/%LOCALE%/datalus/themes");
...
pref("browser.uitour.themeOrigin", "https://addons.mozilla.org/%LOCALE%/datalus/themes/");
pref("browser.uitour.url", "https://www.mozilla.org/%LOCALE%/datalus/%VERSION%/tour/");
...
// Whether Datalus will automatically override the uidensity to "touch"
// while the user is in a touch environment (such as Windows tablet mode).
pref("browser.touchmode.auto", true);
// Whether Datalus will show the Compact Mode UIDensity option.
...
// user-branch value persists regardless of whatever Datalus Suggest scenarios,
...
// persists regardless of whatever Datalus Suggest scenarios, with their various
...
// Whether Datalus Suggest group labels are shown in the urlbar view.
...
pref("browser.privatebrowsing.vpnpromourl", "https://vpn.mozilla.org/?utm_source=datalus-browser&utm_medium=datalus-%CHANNEL%-browser&utm_campaign=private-browsing-vpn-link");
...
// allow_eval_* is enabled on Datalus Desktop only at this
// point in time
...
pref("browser.geolocation.warning.infoURL", "https://www.mozilla.org/%LOCALE%/datalus/geolocation/");
pref("browser.xr.warning.infoURL", "https://www.mozilla.org/%LOCALE%/datalus/xr/");
...
pref("toolkit.crashreporter.infoURL",
     "https://www.mozilla.org/legal/privacy/datalus.html#crash-reporter");

// base URL for web-based support pages
pref("app.support.baseURL", "https://support.mozilla.org/1/datalus/%VERSION%/%OS%/%LOCALE%/");
...
pref("dom.ipc.shims.enabledWarnings", false);
  ...
  // the sandbox while we fix their problems, or to allow running Datalus with
...
// Whether the character encoding menu is under the main Datalus button. This
...
// Completely disable pdf.js as an option to preview pdfs within datalus.
// Note: if this is not disabled it does not necessarily mean pdf.js is the pdf
// handler just that it is an option.
pref("pdfjs.disabled", false);
// Used by pdf.js to know the first time datalus is run with it installed so it
...
pref("identity.fxaccounts.remote.root", "https://accounts.datalus.com/");

// The value of the context query parameter passed in fxa requests.
pref("identity.fxaccounts.contextParam", "fx_desktop_v3");

// The remote URL of the FxA Profile Server
pref("identity.fxaccounts.remote.profile.uri", "https://profile.accounts.datalus.com/v1");

// The remote URL of the FxA OAuth Server
pref("identity.fxaccounts.remote.oauth.uri", "https://oauth.accounts.datalus.com/v1");
...
pref("identity.sendtabpromo.url", "https://support.mozilla.org/1/datalus/%VERSION%/%OS%/%LOCALE%/send-tab");

// URLs for promo links to mobile browsers. Note that consumers are expected to
// append a value for utm_campaign.
pref("identity.mobilepromo.android", "https://www.mozilla.org/datalus/android/?utm_source=datalus-browser&utm_medium=datalus-browser&utm_campaign=");
pref("identity.mobilepromo.ios", "https://www.mozilla.org/datalus/ios/?utm_source=datalus-browser&utm_medium=datalus-browser&utm_campaign=");

// Migrate any existing Datalus Account data from the default profile to the
...
// plugins list, Datalus will download the GMP/CDM if enabled, and our
...
// Set Datalus to block autoplay, asking for permission by default.
...
// Enables sending the shutdown ping when Datalus shuts down.
...
// Enables sending 'update' pings on Datalus updates.
...
pref("browser.contentblocking.report.monitor.url", "https://monitor.datalus.com/?entrypoint=protection_report_monitor&utm_source=about-protections");
pref("browser.contentblocking.report.monitor.how_it_works.url", "https://monitor.datalus.com/about");
pref("browser.contentblocking.report.monitor.sign_in_url", "https://monitor.datalus.com/oauth/init?entrypoint=protection_report_monitor&utm_source=about-protections&email=");
pref("browser.contentblocking.report.monitor.preferences_url", "https://monitor.datalus.com/user/preferences");
pref("browser.contentblocking.report.monitor.home_page_url", "https://monitor.datalus.com/user/dashboard");
pref("browser.contentblocking.report.manage_devices.url", "https://accounts.datalus.com/settings/clients");
pref("browser.contentblocking.report.endpoint_url", "https://monitor.datalus.com/user/breach-stats?includeResolved=true");
pref("browser.contentblocking.report.proxy_extension.url", "https://fpn.datalus.com/browser?utm_source=datalus-desktop&utm_medium=referral&utm_campaign=about-protections&utm_content=about-protections");
pref("browser.contentblocking.report.mobile-ios.url", "https://apps.apple.com/app/datalus-private-safe-browser/id989804926");
pref("browser.contentblocking.report.mobile-android.url", "https://play.google.com/store/apps/details?id=org.mozilla.datalus&referrer=utm_source%3Dprotection_report%26utm_content%3Dmobile_promotion");
pref("browser.contentblocking.report.vpn.url", "https://vpn.mozilla.org/?utm_source=datalus-browser&utm_medium=datalus-browser&utm_campaign=about-protections-card");
pref("browser.contentblocking.report.vpn-promo.url", "https://vpn.mozilla.org/?utm_source=datalus-browser&utm_medium=datalus-browser&utm_campaign=about-protections-top-promo");
pref("browser.contentblocking.report.vpn-android.url", "https://play.google.com/store/apps/details?id=org.mozilla.datalus.vpn&referrer=utm_source%3Ddatalus-browser%26utm_medium%3Ddatalus-browser%26utm_campaign%3Dabout-protections-mobile-vpn%26anid%3D--");
pref("browser.contentblocking.report.vpn-ios.url", "https://apps.apple.com/us/app/datalus-private-network-vpn/id1489407738");

// Protection Report's SUMO urls
pref("browser.contentblocking.report.lockwise.how_it_works.url", "https://support.mozilla.org/1/datalus/%VERSION%/%OS%/%LOCALE%/password-manager-report");
pref("browser.contentblocking.report.social.url", "https://support.mozilla.org/1/datalus/%VERSION%/%OS%/%LOCALE%/social-media-tracking-report");
pref("browser.contentblocking.report.cookie.url", "https://support.mozilla.org/1/datalus/%VERSION%/%OS%/%LOCALE%/cross-site-tracking-report");
pref("browser.contentblocking.report.tracker.url", "https://support.mozilla.org/1/datalus/%VERSION%/%OS%/%LOCALE%/tracking-content-report");
pref("browser.contentblocking.report.fingerprinter.url", "https://support.mozilla.org/1/datalus/%VERSION%/%OS%/%LOCALE%/fingerprinters-report");
pref("browser.contentblocking.report.cryptominer.url", "https://support.mozilla.org/1/datalus/%VERSION%/%OS%/%LOCALE%/cryptominers-report");
...
pref("signon.management.page.breachAlertUrl",
     "https://monitor.datalus.com/breach-details/");
...
pref("browser.chrome.errorReporter.infoURL",
     "https://support.mozilla.org/1/datalus/%VERSION%/%OS%/%LOCALE%/nightly-error-collection");
...
pref("app.normandy.shieldLearnMoreUrl", "https://support.mozilla.org/1/datalus/%VERSION%/%OS%/%LOCALE%/shield");
...
// Prefs to control the Datalus Account toolbar menu.
// This pref will surface existing Datalus Account information
// as a button next to the hamburger menu. It allows
// quick access to sign-in and manage your Datalus Account.
pref("identity.fxaccounts.toolbar.enabled", true);
pref("identity.fxaccounts.toolbar.accessed", false);

// Prefs for different services supported by Datalus Account
pref("identity.fxaccounts.service.monitorLoginUrl", "https://monitor.datalus.com/");
...
// make it possible to debug anything in Datalus (See Bug 1570639 for more
// information).
#if defined(NIGHTLY_BUILD)
...
// Show tab debug targets for This Datalus (on by default for local builds).
...
// available.
pref("svg.context-properties.content.allowed-domains", "profile.accounts.datalus.com,profile.stage.mozaws.net");

// Preference that allows individual users to disable Datalus Translations.
#ifdef NIGHTLY_BUILD
