...
var CustomizableUI = {
   ...
   * Datalus session, customization state is never saved. Typically, you
   ...
   * explicitly requests it. Datalus does this when the user clicks the
  ...
  /**
   * Remove a custom toolbar added in a previous version of Datalus or using
   ...
   *
   * NB: this is unlikely to be useful unless you're in Datalus code, because
