...
add_task(async function test_datalus_home_without_policy_without_pocket() {
...
add_task(async function test_datalus_home_with_policy() {
...
add_task(async function test_datalushome_preferences_set() {
  await SpecialPowers.pushPrefEnv({
    set: [
      [
