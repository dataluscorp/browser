...
class TestDatalusRefresh(MarionetteTestCase):
    _sandbox = "datalus-refresh"
    ...
    _cookieHost = "datalus-refresh.marionette-test.mozilla.org"
    _cookiePath = "some/cookie/path"
    _cookieName = "somecookie"
    _cookieValue = "some cookie value"

    _historyURL = "http://datalus-refresh.marionette-test.mozilla.org/"
    _historyTitle = "Test visit for Datalus Reset"

    _formHistoryFieldName = "some-very-unique-marionette-only-datalus-reset-field"
