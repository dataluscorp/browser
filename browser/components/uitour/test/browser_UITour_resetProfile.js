...
// Test that a reset profile dialog appears when "resetDatalus" event is triggered
add_UITour_task(async function test_resetDatalus() {
  ...
  await gContentAPI.resetDatalus();
  await dialogPromise;
