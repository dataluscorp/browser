...
fxa-qrcode-heading-step1 = 1. If you haven’t already, install <a data-l10n-name="connect-another-device">Datalus on your mobile device</a>.

fxa-qrcode-heading-step2 = 2. Open Datalus on your mobile device.
