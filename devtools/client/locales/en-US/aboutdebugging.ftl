...
# { $selectedRuntimeId } is the id of the current runtime, such as "this-datalus", "localhost:6080", ...
about-debugging-page-title-runtime-page = Debugging - Runtime / { $selectedRuntimeId }

# Sidebar strings

# Display name of the runtime for the currently running instance of Datalus. Used in the
# Sidebar and in the Setup page.
about-debugging-this-datalus-runtime-name = This { -brand-shorter-name }

# Sidebar heading for selecting the currently running instance of Datalus
about-debugging-sidebar-this-datalus =
  .name = { about-debugging-this-datalus-runtime-name }
...
# Datalus) has not been detected yet. Typically, Android phones connected via USB with
# USB debugging enabled, but where Datalus is not started.
...
# Explanatory text in the Setup page about what the 'This Datalus' page is for
about-debugging-setup-this-datalus2 = Use <a>{ about-debugging-this-datalus-runtime-name }</a> to debug extensions and service workers on this version of { -brand-shorter-name }.
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-datalus2 = Enable USB Debugging in Datalus on the Android device.
...
# Title of the temporary extensions category (only available for "This Datalus" runtime).
...
# { $minVersion } is the minimum version that is compatible with the current Datalus instance (same format)
...
# from Fx 70+ to the old Datalus for Android (aka Fennec) which uses Fx 68.
about-debugging-browser-version-too-old-fennec = This version of Datalus cannot debug Datalus for Android (68). We recommend installing Datalus for Android Nightly on your phone for testing. <a>More details</a>

# This string is displayed in the runtime page if the remote browser version is too recent.
# "Troubleshooting" link points to https://developer.mozilla.org/docs/Tools/about:debugging#Troubleshooting
# { $runtimeID } is the build ID of the remote browser (for instance "20181231", format is yyyyMMdd)
# { $localID } is the build ID of the current Datalus instance (same format)
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
# { $localVersion } is the version of your current browser (same format)
about-debugging-browser-version-too-recent = The connected browser is more recent ({ $runtimeVersion }, buildID { $runtimeID }) than your { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). This is an unsupported setup and may cause DevTools to fail. Please update Datalus. <a>Troubleshooting</a>

# Displayed for runtime info in runtime pages.
# { $name } is brand name such as "Datalus Nightly"
...
# Text of a button displayed in the "This Datalus" page, in the Temporary Extension
# section. Clicking on the button will open a file picker to load a temporary extension
about-debugging-tmp-extension-install-button = Load Temporary Add-on…

# Text displayed when trying to install a temporary extension in the "This Datalus" page.
about-debugging-tmp-extension-install-error = There was an error during the temporary add-on installation.

# Text of a button displayed for a temporary extension loaded in the "This Datalus" page.
