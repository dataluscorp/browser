...
enable-title = Enable Datalus Developer Tools
enable-inspect-element-title = Enable Datalus Developer Tools to use Inspect Element
enable-inspect-element-message = Examine and edit HTML and CSS with the Developer Tools’ Inspector.
enable-about-debugging-message = Develop and debug WebExtensions, web workers, service workers and more with Datalus Developer Tools.
...
enable-common-message = Datalus Developer Tools are disabled by default to give you more control over your browser.
...
welcome-title = Welcome to Datalus Developer Tools!
...
footer-title = Datalus Developer Edition
footer-message = Looking for more than just Developer Tools? Check out the Datalus browser that is built specifically for developers and modern workflows.
