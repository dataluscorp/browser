Debugging Datalus with Valgrind
===============================
...
Valgrind runs desktop Datalus fine on Linux, especially on x86 and
x86-64. Datalus for Android and Datalus OS on ARMv7 should also run,
...
Datalus's JITs and newer toolchain components (compiler, libc and linker
versions).
...
Build Datalus with the following options, which maximize speed and
accuracy.
...
:ref:`above <Debugging Datalus With Valgrind>`. You might also
...
acts up, first of all read this page and make sure you have both Datalus
