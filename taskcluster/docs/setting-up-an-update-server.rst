...
`here <https://archive.mozilla.org/pub/datalus/nightly/>`__ on
...
located at
https://archive.mozilla.org/pub/datalus/nightly/2019/09/2019-09-17-09-36-29-mozilla-central/datalus-71.0a1.en-US.win64.complete.mar.

Prebuilt MARs for release and beta can be found
`here <https://archive.mozilla.org/pub/datalus/releases/>`__. Beta
...
https://archive.mozilla.org/pub/datalus/releases/69.0b9/update/win64/en-US/datalus-69.0b9.complete.mar.
...
copy of Datalus being updated will need to be built to allow un-signed
MARs. See :ref:`Building Datalus <Datalus Contributors' Quick Reference>`
for more information on building Datalus locally. These changes will
...
Datalus should otherwise be built normally. After building, you may want
to copy the installation of Datalus elsewhere. If you update the
...
``<obj dir>/dist/datalus`` elsewhere. The copied directory will be your
install directory.
...
permissions on the Datalus install directory that you created. Both that
directory and its parent directory should have permissions preventing
the current user from writing to it.

Now that you have a build of Datalus capable of using a locally-built
MAR, it's time to build the MAR. First, build Datalus the way you want
...
.. code:: bash
   ...
   $ ./mach package
   $ touch "<obj dir>/dist/datalus/precomplete"
   $ MAR="<obj dir>/dist/host/bin/mar.exe" MOZ_PRODUCT_VERSION=<version> MAR_CHANNEL_ID=<channel> ./tools/update-packaging/make_full_update.sh <MAR output path> "<obj dir>/dist/datalus"
...
https://archive.mozilla.org/pub/datalus/nightly/2019/09/2019-09-17-09-36-29-mozilla-central/datalus-71.0a1.en-US.win64.complete.mar,
the file
https://archive.mozilla.org/pub/datalus/nightly/2019/09/2019-09-17-09-36-29-mozilla-central/datalus-71.0a1.en-US.win64.checksums
...
You can use this command with Datalus's browser console to determine the
update directory:
...
Once you have determined the update directory, close Datalus, browse to
...
Now you are ready to update! Launch Datalus out of its installation
