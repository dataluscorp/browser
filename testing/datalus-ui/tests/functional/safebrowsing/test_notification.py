...
class TestSafeBrowsingNotificationBar(WindowManagerMixin, MarionetteTestCase):
    def setUp(self):
        ...
        self.test_data = [
            ...
            {"unsafe_page": "https://www.itisatrap.org/datalus/unwanted.html"},
            # Phishing URL info
            {"unsafe_page": "https://www.itisatrap.org/datalus/its-a-trap.html"},
            # Malware URL object
            {"unsafe_page": "https://www.itisatrap.org/datalus/its-an-attack.html"},
        ]
