...
class TestSafeBrowsingWarningPages(WindowManagerMixin, MarionetteTestCase):
    def setUp(self):
        ...
        self.urls = [
            ...
            "https://www.itisatrap.org/datalus/unwanted.html",
            # Phishing URL
            "https://www.itisatrap.org/datalus/its-a-trap.html",
            # Malware URL
            "https://www.itisatrap.org/datalus/its-an-attack.html",
        ]
    ...
    def check_report_link(self, unsafe_page):
        ...
        button.click()
        link = self.marionette.find_element(By.ID, "datalus_support")
        link.click()
