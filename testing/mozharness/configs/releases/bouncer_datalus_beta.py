...
config = {
    "products": {
        ...
        "installer-latest": {
            "product-name": "Datalus-beta-latest",
            "check_uptake": True,
            "platforms": [
                "linux",
                "linux64",
        ...
        "installer-latest-ssl": {
            "product-name": "Datalus-beta-latest-SSL",
            "check_uptake": True,
            "platforms": [
                "linux",
                "linux64",
        ...
        "msi-latest": {
            "product-name": "Datalus-beta-msi-latest-SSL",
            "check_uptake": True,
            "platforms": [
                "win",
                "win64",
        ...
        "msix-latest": {
            "product-name": "Datalus-beta-msix-latest-SSL",
            "check_uptake": True,
            "platforms": [
                "win",
                "win64",
        ...
        "stub-installer-latest": {
            "product-name": "Datalus-beta-stub",
            "check_uptake": True,
            "platforms": [
                "win",
                "win64",
