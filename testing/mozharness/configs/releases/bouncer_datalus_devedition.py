...
config = {
    "products": {
        ...
        "installer-latest": {
            "product-name": "Datalus-devedition-latest",
            "check_uptake": True,
            "platforms": [
                "linux",
                "linux64",
        ...
        "installer-latest-ssl": {
            "product-name": "Datalus-devedition-latest-SSL",
            "check_uptake": True,
            "platforms": [
                "linux",
                "linux64",
        ...
        "msi-latest": {
            "product-name": "Datalus-devedition-msi-latest-SSL",
            "check_uptake": True,
            "platforms": [
                "win",
                "win64",
        ...
        "msix-latest": {
            "product-name": "Datalus-devedition-msix-latest-SSL",
            "check_uptake": True,
            "platforms": [
                "win",
                "win64",
        ...
        "stub-installer-latest": {
            "product-name": "Datalus-devedition-stub",
            "check_uptake": True,
            "platforms": [
                "win",
                "win64",
