...
config = {
    ...
    "update_channels": {
        "beta": {
            ...
            "mar_channel_ids": [
                "datalus-mozilla-beta",
                "datalus-mozilla-release",
            ],
            "channel_names": ["beta", "beta-localtest", "beta-cdntest"],
            "rules_to_update": ["datalus-beta-cdntest", "datalus-beta-localtest"],
            "publish_rules": [32],
            "schedule_asap": True,
        },
        "release": {
            ...
            "rules_to_update": ["datalus-release-cdntest", "datalus-release-localtest"],
            "publish_rules": [145],
        },
    },
