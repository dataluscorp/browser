...
class TPSDatalusRunner(object):
    ...
    def download_build(self, installdir="downloadedbuild", appname="datalus"):
    ...
    def run(self, profile=None, timeout=PROCESS_TIMEOUT, env=None, args=None):
        """Runs the given DatalusRunner with the given Profile, waits
