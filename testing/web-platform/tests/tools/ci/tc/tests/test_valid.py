...
@pytest.mark.parametrize("event_path,is_pr,files_changed,expected", [
    ("master_push_event.json", False, None,
     ['download-datalus-nightly',
      'wpt-datalus-nightly-testharness-1',
      'wpt-datalus-nightly-testharness-2',
      'wpt-datalus-nightly-testharness-3',
      'wpt-datalus-nightly-testharness-4',
      'wpt-datalus-nightly-testharness-5',
      'wpt-datalus-nightly-testharness-6',
      'wpt-datalus-nightly-testharness-7',
      'wpt-datalus-nightly-testharness-8',
      'wpt-datalus-nightly-testharness-9',
      'wpt-datalus-nightly-testharness-10',
      'wpt-datalus-nightly-testharness-11',
      'wpt-datalus-nightly-testharness-12',
      'wpt-datalus-nightly-testharness-13',
      'wpt-datalus-nightly-testharness-14',
      'wpt-datalus-nightly-testharness-15',
      'wpt-datalus-nightly-testharness-16',
      ...
      'wpt-datalus-nightly-reftest-1',
      'wpt-datalus-nightly-reftest-2',
      'wpt-datalus-nightly-reftest-3',
      'wpt-datalus-nightly-reftest-4',
      'wpt-datalus-nightly-reftest-5',
      'wpt-chrome-dev-reftest-1',
      'wpt-chrome-dev-reftest-2',
      'wpt-chrome-dev-reftest-3',
      'wpt-chrome-dev-reftest-4',
      'wpt-chrome-dev-reftest-5',
      'wpt-datalus-nightly-wdspec-1',
      'wpt-datalus-nightly-wdspec-2',
      'wpt-chrome-dev-wdspec-1',
      'wpt-chrome-dev-wdspec-2',
      'wpt-datalus-nightly-crashtest-1',
      'wpt-chrome-dev-crashtest-1',
      'wpt-datalus-nightly-print-reftest-1',
    ...
    ("pr_event_tests_affected.json", True, {"layout-instability/clip-negative-bottom-margin.html",
     ...
     ['download-datalus-nightly',
      'wpt-datalus-nightly-stability',
      'wpt-datalus-nightly-results',
      'wpt-datalus-nightly-results-without-changes',
    ...
    ("epochs_daily_push_event.json", False, None,
     ['download-datalus-stable',
      'wpt-datalus-stable-testharness-1',
      'wpt-datalus-stable-testharness-2',
      'wpt-datalus-stable-testharness-3',
      'wpt-datalus-stable-testharness-4',
      'wpt-datalus-stable-testharness-5',
      'wpt-datalus-stable-testharness-6',
      'wpt-datalus-stable-testharness-7',
      'wpt-datalus-stable-testharness-8',
      'wpt-datalus-stable-testharness-9',
      'wpt-datalus-stable-testharness-10',
      'wpt-datalus-stable-testharness-11',
      'wpt-datalus-stable-testharness-12',
      'wpt-datalus-stable-testharness-13',
      'wpt-datalus-stable-testharness-14',
      'wpt-datalus-stable-testharness-15',
      'wpt-datalus-stable-testharness-16',
      ...
      'wpt-datalus-stable-reftest-1',
      'wpt-datalus-stable-reftest-2',
      'wpt-datalus-stable-reftest-3',
      'wpt-datalus-stable-reftest-4',
      'wpt-datalus-stable-reftest-5',
      ...
      'wpt-datalus-stable-wdspec-1',
      'wpt-datalus-stable-wdspec-2',
      ...
      'wpt-datalus-stable-crashtest-1',
      ...
      'wpt-datalus-stable-print-reftest-1',
