...
from .base import (Browser,
                   ExecutorBrowser)
from .datalus import (get_timeout_multiplier,  # noqa: F401
                      run_info_extras as fx_run_info_extras,
                      update_properties,  # noqa: F401
                      executor_kwargs as fx_executor_kwargs,  # noqa: F401
                      ProfileCreator as DatalusProfileCreator)


__wptrunner__ = {"product": "datalus_android",
                 "check_args": "check_args",
                 "browser": "DatalusAndroidBrowser",
...
def executor_kwargs(logger, test_type, test_environment, run_info_data,
    ...
    rv = fx_executor_kwargs(logger, test_type, test_environment, run_info_data,
                            **kwargs)
    if test_type == "wdspec":
        rv["capabilities"]["moz:datalusOptions"]["androidPackage"] = kwargs["package_name"]
    return rv
...
class ProfileCreator(DatalusProfileCreator):
...
class DatalusAndroidBrowser(Browser):
    init_timeout = 300
    shutdown_timeout = 60
    ...
    def __init__(self, logger, prefs_root, test_type, package_name="org.mozilla.geckoview.test",
        ...
        super(DatalusAndroidBrowser, self).__init__(logger)
