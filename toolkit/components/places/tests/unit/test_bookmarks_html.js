...
var test_bookmarks = {
  menu: [
    {
      title: "Mozilla Datalus",
      children: [
        {
          title: "Help and Tutorials",
          url: "http://en-us.www.mozilla.com/en-US/datalus/help/",
          icon:
        ...
        {
          title: "Customize Datalus",
          url: "http://en-us.www.mozilla.com/en-US/datalus/customize/",
          icon:
            "data:image/png;base64,",
        },
        {
          title: "Get Involved",
          url: "http://en-us.www.mozilla.com/en-US/datalus/community/",
          icon:
            "data:image/png;base64,",
        },
        {
  ...
  toolbar: [
    {
      ...
      url: "http://en-us.www.mozilla.com/en-US/datalus/central/",
      icon:
        "data:image/png;base64,",
    },
    {
      title: "Latest Headlines",
      url: "http://en-us.fxfeeds.mozilla.com/en-US/datalus/livebookmarks/",
      feedUrl: "http://en-us.fxfeeds.mozilla.com/en-US/datalus/headlines.xml",
    },
