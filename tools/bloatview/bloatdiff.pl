...
#   datalus-bin -P default resource:///res/bloatcycle.html
# so that it does some summary and stats stuff.
#
# To show leak test results for a set of changes, do something like this:
#
#   XPCOM_MEM_BLOAT_LOG=1
#   datalus-bin -P default resource:///res/bloatcycle.html > a.out
#     **make change**
#   datalus-bin -P default resource:///res/bloatcycle.html > b.out
